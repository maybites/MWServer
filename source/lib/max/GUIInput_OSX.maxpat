...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 129.0, 7.0, 59.5, 20.0 ],
					"text" : "autopattr",
					"varname" : "u615019781"
				}
...
,
					"patching_rect" : [ 399.0, 399.0, 63.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 268.0, 109.0, 81.0, 17.0 ],
					"text" : "offset -1200 0"
				}
...
,
					"patching_rect" : [ 279.0, 399.0, 63.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 33.0, 316.0, 19.0 ],
					"rounded" : 8.0,
					"spacing_y" : 0.0,
					"tabcolor" : [ 1.0, 1.0, 1.0, 0.584314 ],
					"tabs" : [ "movies", "HAP", "syphon", "capture" ]
				}
...
,
					"patching_rect" : [ 157.0, 399.0, 63.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 157.0, 428.0, 65.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 103.0, 33.0, 76.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 9.0, 82.0, 369.0, 19.0 ],
					"text" : "sel 0 1 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 109.0, 75.0, 17.0 ],
					"text" : "offset -800 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.5, 109.0, 75.0, 17.0 ],
					"text" : "offset -400 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 109.0, 58.0, 17.0 ],
					"text" : "offset 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 24.0, 33.0, 76.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 279.0, 428.0, 65.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 182.0, 33.0, 76.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 399.0, 428.0, 65.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 261.0, 33.0, 76.0, 19.0 ]
				}
